...
_QUERYINDEXSHAREDLISTMSGREQ = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='zone', full_name='eddid.quote.QueryIndexSharedListMsgReq.zone', index=0,
      number=1, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='index', full_name='eddid.quote.QueryIndexSharedListMsgReq.index', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='start_time_stamp', full_name='eddid.quote.QueryIndexSharedListMsgReq.start_time_stamp', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sub_quote_type', full_name='eddid.quote.QueryIndexSharedListMsgReq.sub_quote_type', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_QUERYINDEXSHAREDLISTMSGREQ.fields_by_name['zone'].enum_type = common__type__def__pb2._ZONETYPE
_QUERYINDEXSHAREDLISTMSGREQ.fields_by_name['index'].enum_type = common__type__def__pb2._INDEXTYPE
